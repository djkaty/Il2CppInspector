...
namespace Il2CppTests.TestSources
{
	...
	{
		// Fields
		public SkillCastType skillCastType; // 0x10
		public bool testb1; // 0x14
		public string codeName; // 0x20
		public int level; // 0x28
		public string skillNameInCombo; // 0x30
		public string customProjectileName; // 0x38
		public float channelingTime; // 0x40
		public bool noPause; // 0x44
		public float cooldown; // 0x48
		public float castTime; // 0x4C
		public float delayActiveTime; // 0x50
		public float projectileSpeed; // 0x54
		public float range; // 0x58
		public float[] param1; // 0x60
		public float[] param2; // 0x68
		public float[] param3; // 0x70
		public float[] param4; // 0x78
		public float[] param5; // 0x80
		public float[] param6; // 0x88
		public float[] param7; // 0x90
		public int[] levelUp; // 0x98
		public float radiusAOE; // 0xA0
		public int maxTarget; // 0xA4
		public float manaCost; // 0xA8
		public bool isAttached; // 0xAC
		protected int cooldownTick; // 0xB0
		protected bool isApplying; // 0xB4
		protected bool isChanneling; // 0xB5
		public bool IsCallAfterOtherSkill; // 0xB6
		protected int applyTick; // 0xB8
		protected int channelingTick; // 0xBC
		protected int activeTick; // 0xC0
		protected bool isActived; // 0xC4
		protected float mskillFactor; // 0xC8
		public string OnFinishUseSkillAction; // 0xD0
		private SkillBase skillInCombo; // 0xD8
		private bool onDemandPassiveActived; // 0xE0
	
		// Properties
		public ElementType Element { get; set; } // 0x0000000180154AB0-0x0000000180154AC0 0x000000018019CA20-0x000000018019CA30
		public int LevelIndex1 { get => default; } // 0x000000018071B180-0x000000018071B190 
		public bool IsCooldown { get; set; } // 0x000000018071B170-0x000000018071B180 0x000000018071B190-0x000000018071B190
	
		// Constructors
		public SkillBase() {} // 0x000000018071B160-0x000000018071B170
	
		// Methods
		public void OnTick() {} // 0x00000001801252F0-0x0000000180125300
	}
}
